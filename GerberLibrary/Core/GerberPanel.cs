...
namespace GerberLibrary
{
    ...
    public class GerberPanel
    {
        ...
        public List<PointD> DrillHoles = new List<PointD>();
        public double DrillToolRadius = 0.25;
        ...
        public List<PathDefWithClosed> FinalPolygonsWithTabs = new List<PathDefWithClosed>();
        ...
        public List<string> SaveOutlineTo(string p, string combinedfilename, ProgressLog TheLog)
        {
            ...
            EF.Tools[1] = new ExcellonTool() { ID = 1, Radius = DrillToolRadius };
